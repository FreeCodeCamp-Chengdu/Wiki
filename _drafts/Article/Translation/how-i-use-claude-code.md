...
我把 [Claude Code][11] 当作主力开发工具已经大约 9 个月了，而我最终形成的工作流，和大多数人使用 AI 编码工具的方式截然不同。多数开发者是输入一个 prompt（提示词），有时开计划模式，修错，再重复。更“常年泡在技术社区”的那拨人，还会把 ralph loops、MCPs、gas towns（当年流行过的几种编排玩法）之类的东西串起来。两种方式最后都很乱，一碰到稍微复杂的任务就会散架。
