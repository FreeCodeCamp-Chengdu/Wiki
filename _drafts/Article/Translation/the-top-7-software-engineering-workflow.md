...
通过高级工程师、经理和CTO [Ricardo Morales][13] 的真实世界挑战来学习系统设计。我最近喜欢的一个是[设计 Google Sheets][14]。
...
xkcd 时间优化图表。注意：它对"工作日"来说并不完全准确，因为它是基于24小时制的。[来源][16]
...
在高层次上，我建议查看[这篇终端改造文章的目录][17]。不过，我会介绍3个主要的时间节省方法。
...
- [iTerm2][18] - 终端
- [Oh-my-zsh][19] 和 Zsh (bash的替代品) - [设置指南在这里][19]
...
添加[SCM Breeze][21]允许你轻松处理Git中的文件。
...
我使用[Todoist][24]和Slack的"稍后保存"提醒的组合来存储任何想法或任务，这样我就可以立即把它从我的大脑中清除。
...
我使用[Rectangle][29]。它是免费的，专业版终身访问只需10美元。
...
- [如何在顶级科技公司获得更多面试、offer和薪酬][32] - 即将举行的LinkedIn直播活动，由我和Alan Stein（在多家FAANG公司担任Director+级别）主持。点击链接参加。将在本周二，10月10日太平洋时间下午5点举行。
...
1. _新的辅导客户：查看[Mentorcruise的费率][33]_
2. _通讯赞助：请回复此邮件联系我。_
