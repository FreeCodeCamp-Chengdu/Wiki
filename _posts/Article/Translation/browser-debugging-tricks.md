...
authors:
  - luojiyin1987
original: https://alan.norbauer.com/articles/browser-debugging-tricks
categories:
  - Article
  - Translation
photos:
  - https://stackdiary.com/wp-content/uploads/2022/06/Chrome-DevTools-tips-and-tricks-for-developers.png
toc: true
---
...
更新（2020 年 5 月）：所有主流浏览器现在都直接支持日志断点/跟踪断点 ([Chrome Logpoints][1]，[Edge Tracepoints][2]，[Firefox Logpoints][3])
...
然后 “Step into next function call”（进入下一个函数调用），以调试 `fn` 的实现。
...
1.  除非浏览器标识另有说明，否则 Chrome、Firefox 和 Edge 浏览器均支持提示功能：

|                                Chrome                                 |                                Edge                                 |                                Firefox                                 | Safari |
| :-------------------------------------------------------------------: | :-----------------------------------------------------------------: | :--------------------------------------------------------------------: | :----: |
| ![](https://alan.norbauer.com/_next/static/media/chrome.2d2a19fd.svg) | ![](https://alan.norbauer.com/_next/static/media/edge.c22c90ce.svg) | ![](https://alan.norbauer.com/_next/static/media/firefox.583d9a58.svg) |        |

[1]: https://developers.google.com/web/updates/2019/01/devtools#logpoints
[2]: https://docs.microsoft.com/en-us/microsoft-edge/devtools-guide/debugger#breakpoints
[3]: https://developer.mozilla.org/en-US/docs/Tools/Debugger/Set_a_logpoint
